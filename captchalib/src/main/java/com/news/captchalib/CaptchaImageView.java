...
import static com.news.captchalib.CaptchaImageView.Direction.B;
import static com.news.captchalib.CaptchaImageView.Direction.B_ao;
import static com.news.captchalib.CaptchaImageView.Direction.B_tu;
import static com.news.captchalib.CaptchaImageView.Direction.L;
import static com.news.captchalib.CaptchaImageView.Direction.L_ao;
import static com.news.captchalib.CaptchaImageView.Direction.L_tu;
import static com.news.captchalib.CaptchaImageView.Direction.R;
import static com.news.captchalib.CaptchaImageView.Direction.R_ao;
import static com.news.captchalib.CaptchaImageView.Direction.R_tu;
import static com.news.captchalib.CaptchaImageView.Direction.T;
import static com.news.captchalib.CaptchaImageView.Direction.T_ao;
import static com.news.captchalib.CaptchaImageView.Direction.T_tu;
...
public class CaptchaImageView extends AppCompatImageView {
    ...
    public void reset() {
        mStatus = SwipeCaptchaHelper.Status.INIT;
        invalidate();
    }
