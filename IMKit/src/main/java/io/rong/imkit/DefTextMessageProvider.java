...
public class DefTextMessageProvider extends IContainerItemProvider.MessageProvider<TextMessage>{
    ...
    public View newView(Context context, ViewGroup group) {
        View view = LayoutInflater.from(context).inflate(R.layout.def_item_text_message, null);

        DefTextMessageProvider.ViewHolder holder = new DefTextMessageProvider.ViewHolder();
    ...
    public void onItemLongClick(final View view, int position, final TextMessage content, final UIMessage message) {
        ...
        DefTextMessageProvider.ViewHolder holder = (DefTextMessageProvider.ViewHolder) view.getTag();
    ...
    @Override
    public void bindView(final View v, int position, final TextMessage content, final UIMessage data) {
        DefTextMessageProvider.ViewHolder holder = (DefTextMessageProvider.ViewHolder) v.getTag();
        ...
        if (data.getMessageDirection() == Message.MessageDirection.SEND) {
            ...
            holder.message.setTextColor(v.getResources().getColor(R.color.text_main_color));
        }
