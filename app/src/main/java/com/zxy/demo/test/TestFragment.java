...
public class TestFragment extends ApiBaseFragment {
    ...
    protected void initView() {
        ...
        tv.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, SystemUtil.dp2px(mActivity,100)));
        ...
        rvContent.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
                ...
                outRect.right = SystemUtil.dp2px(mActivity,10);
                outRect.bottom = SystemUtil.dp2px(mActivity,10);
            }
        });
