...
public class BaseAppView extends FrameLayout implements
        ...
        BaseActivity.ActivityLifecycleCallback,
        BaseActivity.ActivityResultCallback,
        BaseActivity.ActivityTouchEventCallback,
        BaseActivity.ActivityKeyEventCallback
{
     ...
     * @return
     */
    public BaseAppView setContainer(View container)
    {
        if (container == null)
        {
            mContainer = null;
