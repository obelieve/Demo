...
public class HomeItemRv extends RecyclerView {

    public HomeItemRv(Context context) {
        super(context);
    }

    public HomeItemRv(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HomeItemRv(Context context, @Nullable AttributeSet attrs, int defStyle) {
