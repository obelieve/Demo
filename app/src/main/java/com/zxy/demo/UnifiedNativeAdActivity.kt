...
import kotlinx.android.synthetic.main.activity_unified_native_ad.*
import java.util.*
 ...
 * 原生高级广告
 */
class UnifiedNativeAdActivity : AppCompatActivity() {

  override fun onCreate(savedInstanceState: Bundle?) {
    super.onCreate(savedInstanceState)
    setContentView(R.layout.activity_unified_native_ad)
  ...
  private fun refreshAd() {
    ...
    val adLoader = builder.withAdListener(object : AdListener() {
      override fun onAdFailedToLoad(loadAdError: LoadAdError) {
        ...
        refresh_button.isEnabled = true
        Toast.makeText(
          this@UnifiedNativeAdActivity, "Failed to load native ad with error $error",
          Toast.LENGTH_SHORT
        ).show()
      }
    }).build()
