...
public final class LogUtil {
    ...
    public static class LogWindow {
        ...
        private LinkedList<LineMessage> mList = new LinkedList<LineMessage>();
        ...
        private static class LineMessage {
            ...
            public LineMessage(String content, int length, int color) {
