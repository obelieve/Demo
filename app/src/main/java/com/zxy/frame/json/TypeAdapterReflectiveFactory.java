 ...
 * @author huilin
 */
class TypeAdapterReflectiveFactory implements TypeAdapterFactory {
    private final ConstructorConstructor constructorConstructor;
    private final FieldNamingStrategy fieldNamingPolicy;
    private final Excluder excluder;

    public TypeAdapterReflectiveFactory(ConstructorConstructor constructorConstructor,
    ...
    private TypeAdapterReflectiveFactory.BoundField createBoundField(final Gson context,
                                                                     final Field field,
                                                                     final String name,
        ...
        return new TypeAdapterReflectiveFactory.BoundField(name, serialize, deserialize) {
