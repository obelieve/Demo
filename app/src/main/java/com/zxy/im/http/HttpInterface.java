...
import com.zxy.im.utils.MessageDigestUtils;
...
public class HttpInterface
{
    ...
    public static void requestGetToken(String userId, String name, String portraitUri, UIThreadCallback callback)
    {
        ...
        final String signature = MessageDigestUtils.SHA1("UqyuBg4necCG" + nonce + timestamp);
    ...
    public static void requestLogin(String mobile, String password, UIThreadCallback callback)
    {
