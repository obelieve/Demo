...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        LogUtil.e("onTouchEvent="+b+" "+ MotionEventUtil.name(event)+" scrollHorizontal="+(canScrollHorizontally(-1)));
        return b;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        LogUtil.e("onInterceptTouchEvent="+b+" "+ MotionEventUtil.name(ev)+" scrollHorizontal="+(canScrollHorizontally(-1)));
        return b;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        LogUtil.e("dispatchTouchEvent=" + b+" "+ MotionEventUtil.name(ev)+" scrollHorizontal="+(canScrollHorizontally(-1)));
        return b;
    }
