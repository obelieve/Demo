package com.zxy.frame.utils.log;
...
public class LogInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Chain chain) throws IOException {
        ...
        String requestStr = String.format(REQUEST_FORMAT,
                ...
                requestBody != null ? requestBodyContent(requestBody) : null);
        String rBody = null;
        ...
        String responseStr = String.format(RESPONSE_FORMAT,
                ...
                rBody);
        String end = " \n\n ==================================END HTTP/HTTPS===============================\n";
        LogUtil.i("OkHttp", start + requestStr + responseStr + end);
        return response.newBuilder().body(responseBody).build();
    }

    private String requestBodyContent(RequestBody body) {
